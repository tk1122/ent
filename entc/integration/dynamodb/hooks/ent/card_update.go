...
func (cu *CardUpdate) dynamodbSave(ctx context.Context) (n int, err error) {
...
func (cuo *CardUpdateOne) dynamodbSave(ctx context.Context) (_node *Card, err error) {
	_spec := &dynamodbgraph.UpdateSpec{
		Node: &dynamodbgraph.NodeSpec{
			Table: card.Table,
			Keys:  card.Keys,
	...
	if fields := cuo.fields; len(fields) > 0 {
		...
		_spec.Node.Keys = append(_spec.Node.Keys, card.FieldID)
