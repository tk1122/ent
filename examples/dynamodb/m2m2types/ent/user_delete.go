...
func (ud *UserDelete) Exec(ctx context.Context) (int, error) {
	...
	if len(ud.hooks) == 0 {
		affected, err = ud.dynamodbExec(ctx)
	} else {
...
func (ud *UserDelete) dynamodbExec(ctx context.Context) (int, error) {
	...
	return dynamodbgraph.DeleteNodes(ctx, ud.driver, _spec)
}
