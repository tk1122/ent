...
func (nd *NodeDelete) Exec(ctx context.Context) (int, error) {
	...
	if len(nd.hooks) == 0 {
		affected, err = nd.dynamodbExec(ctx)
	} else {
...
func (nd *NodeDelete) dynamodbExec(ctx context.Context) (int, error) {
	...
	return dynamodbgraph.DeleteNodes(ctx, nd.driver, _spec)
}
